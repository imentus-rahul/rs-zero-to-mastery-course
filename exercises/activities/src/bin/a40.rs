...
// Tuple Structure // accessible using .0 method
...
#[cfg(test)]
mod test{
    use super::*; // we can access everything that's created
    ...
    fn update_status(){
        ...
        // RefCell lets your data vehicles to be modified anywhere
        // Since Refcell is moved into a Rc: It lets you share the data anywhere
